...
class UDPXDRWithNamesSimpleNetworkExperiment(SimpleNetworkExperiment):
       ...
       def startConsumer(self):
           ...
           command = 'screen -dmS udpConsumer java -cp /home/uceeftu/lattice/jars/monitoring-bin-core-2.0.1.jar mon.lattice.appl.dataconsumers.UDPXDRDataConsumerWithNames ' + \
           ...
           if result.ok == True:
              ...
              command = 'pgrep -fn mon.lattice.appl.dataconsumers.UDPXDRDataConsumerWithNames'
