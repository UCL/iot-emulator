...
class WSXDRWithNamesSimpleNetworkExperiment(SimpleNetworkExperiment):
       ...
       def startConsumer(self):
           ...
           command = 'screen -dmS wsConsumer java -cp /home/uceeftu/lattice/jars/monitoring-bin-core-2.0.1.jar mon.lattice.appl.dataconsumers.WebSocketXDRDataConsumerWithNames ' + \
           ...
           if result.ok == True:
              command = 'pgrep -fn mon.lattice.appl.dataconsumers.WebSocketXDRDataConsumerWithNames'
